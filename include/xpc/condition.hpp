#if ! defined XPC66_XPC_CONDITION_HPP
#define XPC66_XPC_CONDITION_HPP
 ...
 *
 *  This module defines the class xpc::condition_var, which provides a common
...
#include <condition_variable>           /* for xpc::synchronizer class    */
